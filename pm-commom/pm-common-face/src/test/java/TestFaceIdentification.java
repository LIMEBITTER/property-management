 ...
 * Desc: 人脸识别测试
 */
public class TestFaceIdentification {
    /**
     * 人脸注册,导入数据100张人脸图片
     */
...
//        String image1 = "https://download.2dfire.com/mis/permanent/img1.jpg";
        String image1 = "https://i.ibb.co/sJMwqLN/test001.jpg";
        String image2 = "http://localhost:9002/test002.jpg";
...
//        String image2 = "https://download.2dfire.com/mis/permanent/img2.jpg";
    ...
    public void test13() {
//        String image = "https://download.2dfire.com/mis/permanent/img1.jpg";
//        String image = "http://localhost:9002/test002.jpg";
        String image = "https://i.ibb.co/sJMwqLN/test001.jpg";
        ImageU imageU = ImageU.builder().data(image).imageTypeEnum(ImageTypeEnum.URL).build();
